...
/**
 * Resultado de una carga masiva de vehiculos, fila por fila.
 *
 * <p>Nunca un simple "listo": un archivo de doscientos vehiculos donde tres
...
@Data
@Builder
public class ImportacionVehiculosResponse {
